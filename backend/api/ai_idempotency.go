...
func writeCanonicalInt64(destination hash.Hash, value int64) {
	// Decimal encoding avoids an implementation-defined signed-to-unsigned
	// conversion while remaining canonical across architectures.
	writeCanonicalString(destination, strconv.FormatInt(value, 10))
}
